...
for (i = 0; i < btns.length; i++) {
    btns[i].setAttribute("onclick", btns[i].innerText);
} // не разобрался как перебрать с помощью forEach..
...
function task1() {
    var t = parseFloat(prompt("Введите температуру в градусах по цельсию"));
